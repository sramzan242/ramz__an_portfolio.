...
hamburger.addEventListener('click', ()=>{
   //Animate Links
    ...
    //     $('.menu-btn i').toggleClass("deactive");
    // });

    // typing text animation script
    var typed = new Typed(".typing", {
        strings: ["Web Developer", "Hackathon Enthusiast", "Front End Developer", "UI Designer", "Photographer", "Technical Things Learner", "Cloud Computing Enthusiast"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true
    });
...
gsap.from(".contact .right button",{
  scrollTrigger:{
      scroller:"body",
      trigger:".contact",
      start:"top 30%",
