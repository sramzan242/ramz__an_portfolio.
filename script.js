...
const loader = ".loader", // without jquery symbols $() because animejs not work with jquery selectors :(
...
hamburger.addEventListener('click', ()=>{
   //Animate Links
    ...
    var typed = new Typed(".typing", {
        strings: ["Web Developer", "Hackathon Enthusiast", "Front End Developer", "UI Designer", "Photography", "Technical Things Learner", "Cloud Computing Enthusiast"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true
    });
